...
import 'package:nabbda/NavigationBarScreens/Calculator/HeartRisk/HeartRisk2.dart';

class HeartRisk1 extends StatefulWidget {
  const HeartRisk1({Key? key}) : super(key: key);

  @override
  State<HeartRisk1> createState() => _HeartRisk1();
}

class _HeartRisk1 extends State<HeartRisk1> {
