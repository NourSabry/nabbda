...
import 'package:nabbda/NavigationBarScreens/HomeScreen/HomeScreens/MedicalDocuments/MedicalDocumentScreens/RadiologyReportsScreens/RadiologyReports.dart';
...
class UploadRadiology extends StatelessWidget {
  @override
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => RadiologyReports1()),
          );
        },
