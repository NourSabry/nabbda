                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      labelText: "Systolic Blood Pressure (mm Hg): ",
                      labelStyle: TextStyle(
                        color: Color(0xFF707070),
                        fontSize: 18,
                        fontWeight: FontWeight.w600,
                  ...
                  Container(
                      alignment: Alignment.topLeft,
                      child: Text("Value must be between 130 - 320",
                          style: TextStyle(
                  ...
                  Container(
                      alignment: Alignment.topLeft,
                      child: Text("Value must be between 20 - 100",
                          style: TextStyle(
                              color: Color(0XFF707070), fontSize: 12))),
                  TextFormField(
                    onSaved: (value) {
                  ...
                  GestureDetector(
                    onTap: () => showDialog<String>(
                      context: context,
                      builder: (BuildContext context) => SmokingAlert(),
                    ),
                    child: Container(
                      ...
                      child: DropdownButtonHideUnderline(
                        child: DropdownButton(
                          ...
                          iconDisabledColor: Color(0xFF0880AE),
                          iconEnabledColor: Color(0xFF0880AE),
                          isExpanded: true,
                        ),
                      ),
                    ),
