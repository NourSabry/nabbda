...
class ContainerDetailsSelectTime extends StatelessWidget {
  ...
  ContainerDetailsSelectTime(
      ...
      this.function,
      this.check,
      this.functionBook,this.functionAccount,this.functionName,this.functionPhone,this.functionGiveFeedback});
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              check! ? DetailsOfOther() : Container(),
              check!
                  ? Container()
                  : RichText(
                      text: TextSpan(
              ...
              Padding(
                ...
                child: ButtonFeedback(
                  book: functionBook!,
                  giveFeedback:functionGiveFeedback!
                ),
              ),
            ],
          ),
